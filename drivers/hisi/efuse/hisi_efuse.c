...
extern u64 security_config_buff_addr_va;
extern u64 security_config_buff_addr_pa;
 ...
 * block allocated by dma_alloc_coherent.*/
	...
	security_config_buff_addr_va = (unsigned char *)dma_alloc_coherent(pdevice, 64, &security_config_buff_addr_pa, GFP_KERNEL);
#endif
    if(NULL == efuse_buf || NULL == security_config_buff_addr_va)
    {
        ret = -EFAULT;
